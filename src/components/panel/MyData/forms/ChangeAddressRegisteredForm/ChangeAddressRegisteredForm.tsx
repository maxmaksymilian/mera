...
import { useChangeAddressRegisteredForm } from './useChangeAddressRegisteredForm';
export type ChangeAddressRegisteredFormProps = {
  address: AddressType;
  type?: string;
  handleClose: () => void;
  handleRefresh: () => void;
...
export const ChangeAddressRegisteredForm = ({
  address,
  handleClose,
  handleRefresh,
}: ChangeAddressRegisteredFormProps) => {
  const { error, form, isLoading, t } = useChangeAddressRegisteredForm({
    address,
    handleClose,
    handleRefresh,
  });
