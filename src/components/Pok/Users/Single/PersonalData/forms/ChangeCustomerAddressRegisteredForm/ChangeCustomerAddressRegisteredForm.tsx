...
import { useChangeCustomerAddressRegisteredForm } from './useChangeCustomerAddressRegisteredForm';

export type ChangeCustomerAddressRegisteredFormProps = {
  id: string;
  address: AddressType;
  type?: string;
  handleClose: () => void;
...
export const ChangeCustomerAddressRegisteredForm = ({
  id,
  address,
  handleClose,
  handleRefresh,
}: ChangeCustomerAddressRegisteredFormProps) => {
  const { error, form, isLoading, t } = useChangeCustomerAddressRegisteredForm({
    id,
    address,
    handleClose,
    handleRefresh,
  ...
  return (
    <Form {...{ id: 'change-address-registered-data-form', form }}>
