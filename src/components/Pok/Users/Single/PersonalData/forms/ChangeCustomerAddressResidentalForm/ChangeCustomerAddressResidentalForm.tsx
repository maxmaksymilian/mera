...
import { useChangeCustomerAddressResidentialForm } from './useChangeCustomerAddressResidentalForm';

export type ChangeCustomerAddressResidentialFormProps = {
  id: string;
  address: AddressType;
  type?: string;
  handleClose: () => void;
...
export const ChangeCustomerAddressResidentialForm = ({
  id,
  address,
  handleClose,
  handleRefresh,
}: ChangeCustomerAddressResidentialFormProps) => {
  const { error, form, isLoading, t } = useChangeCustomerAddressResidentialForm(
    {
      id,
      address,
      handleClose,
